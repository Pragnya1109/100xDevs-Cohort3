...
function App() {
  ...
  const postComponent = posts.map((post) => <PostComponent key={posts.id} name={post.name} title={post.title} time={post.time} profile={post.profile} description={post.description} />)
  ...
  return (
    <div style={{ backgroundColor: "seashell", height: "100vh", padding: "20px" }}>
